 ...
 */
public class Adjust_After_SeeTarget extends Command {
  ...
  protected void execute() {
    ...
    table.getEntry("ledMode").setNumber(0.25);
   ...
   // System.out.println(isSeetarget);
    ...
    //  System.out.println(distance_adjust);  
     ...
     //   is_close=true;
     // }
      Robot.drivebase.speedArcadeDrive(Robot.joy.getRawAxis(1), steering_adjust);
      }
    }
